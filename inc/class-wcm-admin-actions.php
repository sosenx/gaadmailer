...
class wcm_admin_actions{
  ...
  * @return string 
  */
  public static function ikreativ_async_scripts( string $url )
  {
  ...
  *
  * Funkcja dołącza wszystkie pliki w katalogu WCM_PLUGIN_TEMPLATES_DIR/common oraz katalogu zdefiniowanym w stałej WCM_PLUGIN_ADMIN_TEMPLATES_DIR
